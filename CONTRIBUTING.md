...
**This is a beginner-friendly projects to help you get started with your
...
```
git clone https://github.com/gfgtechteam/GFGSCLIETWebDevelopment_hacktoberfest

```
- Navigate to project directory.
```
cd GFGSCLIETWebDevelopment_hacktoberfest
```
